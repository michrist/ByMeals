...
{{-- @foreach ($posts as $post ) --}}
    <div class="card mb-3">
        ...
        <p>By <a class="text-decoration-none" href="/user/{{ $posts[0]->user->username }}">{{ $posts[0]->user->name }}</a> in <a  class="text-decoration-none" href="/categories/{{ $posts[0]->category->slug }}">{{ $posts[0]->category->name }}</a></p>
