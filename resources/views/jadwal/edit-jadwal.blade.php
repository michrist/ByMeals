                ...
                <div class="col-md-6">
                    ...
                    <select name="menu_pagi_id" id="inputMakanPagi" class="form-select">
                        ...
                        @foreach ($menusPagi as $menuPagi)
                            <option value="{{ $menuPagi->idmpasi }}" @if ($schedule->menu_pagi_id === $menuPagi->idmpasi) selected @endif>
                                {{ $menuPagi->nama }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="time" name="waktu_pagi" class="form-control" id="inputWaktuPagi"
                        placeholder="1234 Main St" value="{{ $schedule->waktu_pagi }}">
                </div>
                <div class="col-md-6">
                    ...
                    <select name="menu_siang_id" id="inputMakanSiang" class="form-select">
                        ...
                        @foreach ($menusSiang as $menuSiang)
                            <option value="{{ $menuSiang->idmpasi }}" @if ($schedule->menu_siang_id === $menuSiang->idmpasi) selected @endif>
                                {{ $menuSiang->nama }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <select name="menu_malam_id" id="inputMakanMalam" class="form-select menu_malam">
                        ...
                        @foreach ($menusMalam as $menuMalam)
                            <option value="{{ $menuMalam->idmpasi }}" @if ($schedule->menu_malam_id === $menuMalam->idmpasi) selected @endif>
                                {{ $menuMalam->nama }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
